...
double _kTrackHeight = 24.0;
double _kTrackWidth = 48.0;
double _kTrackRadius = _kTrackHeight / 2.0;
double _kThumbRadius = 9.0;
double _kSwitchWidth =
...
enum SwitchType { inside, outside }

//WSwitch为安卓的两种样式，ios风格直接用CupertionSwitch
...
class _SwitchState extends State<WSwitch> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    if (widget.type == SwitchType.inside) {
      _kTrackHeight = 24;
      _kTrackWidth = 48;
      _kThumbRadius = 9;
    } else {
