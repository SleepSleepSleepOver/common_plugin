...
import 'package:common_plugin/src/widget/player/utils/time_util.dart';
import 'package:common_plugin/src/widget/player/utils/widget_util.dart';
import 'package:flutter/material.dart';
import 'package:flutter_tencentplayer/flutter_tencentplayer.dart';

import '../TCCustomControllBuilder.dart';
import 'fullscreen_route.dart';
import 'tencent_player_linear_progress_indicator.dart';
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  IconButton(
                    color: Colors.white,
                    iconSize: 20,
                    icon: widget.currentFullScreenState
                        ? ImageIcon(AssetImage('images/videoExitScreen.png'))
                        : ImageIcon(AssetImage('images/videoFullscreen.png')),
                    onPressed: () {
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              padding: EdgeInsets.symmetric(
                  vertical: _Style.bottomContainerH / 2 - 1.0),
              child: Stack(
                  ...
                  TencentLinearProgressIndicator(
                    value: controller.value.duration.inMilliseconds <= 0
                        ...
                        : showDuration.inMilliseconds /
                            controller.value.duration.inMilliseconds,
                    valueColor:
                        AlwaysStoppedAnimation<Color>(Color(0xff3F5CFD)),
